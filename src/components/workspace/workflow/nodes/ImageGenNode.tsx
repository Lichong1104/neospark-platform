    ...
    <NodeCard
      ...
      action={
        <button
          ...
          className="nodrag flex h-5 w-5 items-center justify-center rounded border border-foreground/30 text-muted-foreground transition-colors hover:border-accent-cyan hover:bg-accent-cyan hover:text-foreground disabled:opacity-50"
